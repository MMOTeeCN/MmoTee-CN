...
(136,3,'守卫的头','- ...我早就看他不顺眼了'),
(137,12,'称号-守卫','- 生命+25000'),
(138,10,'显示设置','- TAB显示'),
...
(144,10,'称号-工人爷爷','- 挖矿速度提升100%'),
(145,10,'称号-工人奶奶','- 挖矿所得增加100%'),
(146,10,'称号-农民爷爷','- 种地速度提升100%'),
(147,10,'称号-农民奶奶','- 种地所得增加100%'),
(148,10,'称号-手工业','- 合成成功率提升20%'),
(149,10,'称号-公私合营','- 打怪爆率提升30%'),
...
(158,1,'神器-髓岩核心','- 挖矿时概率补偿矿物，锡矿概率增加'),
(159,10,'收集任务计数','- 进度'),
(160,5,'被污染的猪肉','- 用于合成'),
...
(104,4,'Big Wood','- You got 5 woods'),
...
(132,12,'Donate Title - GG Bond!','- Crit 5000% of Rand 95%'),
(133,12,'Donate Title - TANK!','- Health + 7000%'),
(134,12,'Special Title - TeeFun!','- For TeeFun Members'),
(135,12,'Skill The Boulder',''),
(136,12,"Guard's Head",''),
(137,10,'Title Guard','- 生命+25000'),
(138,10,'Show Clan','- TAB显示'),
(139,10,'Guard Hammer Shard','- For Crafting Guard Hammer'),
(140,1,'Guard Hammer','- The Weaker of the Strongs,the Stronger of the weaks'),
(141,1,'Juicer','- Eat all vegetables in 1 go'),
(142,10,'Antiping','- Cut Down Ping'),
(143,4,'Customized Package','- Use Your Own Skin & Color'),
(144,10,'Title WorkerF','- Mining Speed + 100%'),
(145,10,'Title WorkerM','- Mining Got + 100%'),
(146,10,'Title FarmerF','- Farming Speed + 100%'),
(147,10,'Title FarmerM','- Farming Got + 100%'),
(148,10,'Title Manual','- Craft + 20%'),
(149,10,'Title P.P.P.','- Enemy Drop + 30%'),
(150,10,'Title T.G.P.C.R.','- No Angry When Killing'),
(151,10,'Title People Commune','- Exp * 1.5 When Having Vegetable'),
(152,10,'Title G.L.F.','- Move Speed + & "Flamboyant Style"'),
(153,4,'Labour Day Package','- All Titles From the Labour Day'),
(154,10,'Spawn Settings','- Spawn Settings'),
(155,6,'Dragon Pickaxe','- For mining'),
(156,5,'Core Base','- For crafting cores'),
(157,1,'Rare Forest Core','- Cut Wood faster 75%'),
(158,1,'Rare Rock Core','- get more ores & exp when mining'),
...
DROP TABLE IF EXISTS `tw_WarningLog`;
CREATE TABLE `tw_WarningLog` (
  `WarningMessage` varchar(256) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
